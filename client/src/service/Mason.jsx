...
import { product } from "../productdata/masondata";
        ...
        <div className="payment-page">
            ...
            <div id="about" className="p-about">
                ...
                <div className="p-cart">
                    <div className="p-img">
                        <img src="../img/ma.jpg" alt="About plumber" />
            ...
            <div id="item" className="main-layout">
                ...
                <aside className="sidebar left-sidebar">
                    <h3>Categories</h3>
                    <ul>
                        {["All", "Masonry", "Plastering",  "Construction", "Repair"].map((cat) => (
                            <li
                                key={cat}
