...
import { product } from "../productdata/Carpenterdata";
        ...
        <div className="payment-page">
            ...
            <div id="about" className="p-about">
                ...
                <div className="p-cart">
                    <div className="p-img">
                        <img src="../img/ca1.jpg" alt="About plumber" />

                    </div>
                    <div className="p-cart1">
                        <h1>About Carpenter</h1>
                        <h4>Reliable</h4>
            ...
            <div id="repair" className="repair">
                ...
                <div className="repair-col">
                    <div className="repair-card">
                        <img src="../img/ca1.jpg" alt="repair" />
                        <p>Pipe Repair - ₹99</p>
