...
import { product } from "../productdata/Tiledata";
        ...
        <div className="payment-page">
            ...
            <div id="about" className="p-about">
                ...
                <div className="p-cart">
                    <div className="p-img">
                        <img src="../img/t.jpg" alt="About plumber" />
            ...
            <div id="item" className="main-layout">
                ...
                <aside className="sidebar left-sidebar">
                    <h3>Categories</h3>
                    <ul>
                        {["All", "Tile Work", "Cleaning", "Bathroom"].map((cat) => (
                            <li
                                key={cat}
